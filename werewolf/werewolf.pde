      ...
      if (accelerometerValues[1]<=5) {
        if (touch==1) {
          ...
          for (int jj = 0; jj < mug[i].height; jj+=r) {  
            for (int ii = 0; ii < mug[i].width; ii+=r) {  
              ...
              c[ii/int(r)+centerW+jj/int(r)*(width/int(r)+2)+centerH][i+(i-1)-1]= mug[i].pixels[jj * mug[i].width + ii];//真ん中にする処理とか
              c[ii/int(r)+centerW+jj/int(r)*(width/int(r)+2)+centerH][i+(i-1)]= mug[i].pixels[jj * mug[i].width + ii];//真ん中にする処理とか
          ...
          for (int jj = 0; jj < mug[i].height; jj+=r) {  
            for (int ii = 0; ii < mug[i].width; ii+=r) {  
              ...
              c[ii/int(r)+centerW+jj/int(r)*(width/int(r)+2)+centerH][i+(i-1)-1]= mug[i+4].pixels[jj * mug[i].width + ii];//真ん中にする処理とか
              c[ii/int(r)+centerW+jj/int(r)*(width/int(r)+2)+centerH][i+(i-1)]= mug[i+4].pixels[jj * mug[i].width + ii];//真ん中にする処理とか
        ...
        for (int jj = 0; jj < mug[i].height; jj+=r) {  
          for (int ii = 0; ii < mug[i].width; ii+=r) {  
            ...
            c[ii/int(r)+centerW+jj/int(r)*(width/int(r)+2)+centerH][i+(i-1)-1]= mug[0].pixels[jj * mug[i].width + ii];//真ん中にする処理とか
            c[ii/int(r)+centerW+jj/int(r)*(width/int(r)+2)+centerH][i+(i-1)]= mug[0].pixels[jj * mug[i].width + ii];//真ん中にする処理とか

            //c[ii/int(r)+centerW+jj/int(r)*(width/int(r)+2)+centerH][i+9]= mug[0].pixels[jj * mug[i].width + ii];//真ん中にする処理とか
          }
        }
      }
    }
